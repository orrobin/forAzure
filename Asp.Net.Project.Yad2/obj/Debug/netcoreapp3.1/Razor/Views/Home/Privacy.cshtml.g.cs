#pragma checksum "C:\My D\Desktop\Sela\semester 2\קורסים שנגמרו\asp.net project\Asp.Net.Project.Yad2\Asp.Net.Project.Yad2\Views\Home\Privacy.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c0da6c39c4bd79c6158a92290091dc92c0104f0b"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c0da6c39c4bd79c6158a92290091dc92c0104f0b", @"/Views/Home/Privacy.cshtml")]
    ...
    #nullable disable
    {
        ...
        {
#nullable restore
#line 1 "C:\My D\Desktop\Sela\semester 2\קורסים שנגמרו\asp.net project\Asp.Net.Project.Yad2\Asp.Net.Project.Yad2\Views\Home\Privacy.cshtml"
...
");
            ...
            WriteLiteral("<h1>");
#nullable restore
#line 10 "C:\My D\Desktop\Sela\semester 2\קורסים שנגמרו\asp.net project\Asp.Net.Project.Yad2\Asp.Net.Project.Yad2\Views\Home\Privacy.cshtml"
...
<p>
    ...
    Please contact us with any privacy questions by phone at 1-800-345-7669 or online at http://www.playstation.com/support. See the bottom of this Privacy Policy for additional ways to contact us or to contact u");
            WriteLiteral(@"s for specific matters.
    ...
    Registration or PlayStation Network Account (“Account”) Creation Processes, where we ask you to provide information such as: Contact info (e.g. name, email or physical address, country, or phone number); Account Administration Info (e.g. user name, password, or security questions); Billing Information (e.g. credit card or other payment number, billing address); Date of Birth; and Profile Info (e.g. profile photo, languages, likes). Purchase Processes, where we may ask you to provide additional billing info to process payment. Technical and Customer Support Proce");
            WriteLiteral(@"sses, where we may ask you to provide contact info and information related to the issue you are contacting us about. We may also record calls you make to PlayStation Support. Other business processes, where we may ask you to provide information such as name, email address, and Account ID if you participate in market research surveys, beta and other user testing research, competitions, promotions or events or agree to receive marketing information from us.
    ...
    Please make sure that any personal details which you provide are accur");
            WriteLiteral(@"ate and current. We will send any important information relating to your Account to you using the contact information you provide (including Account security and privacy notices). You can check and update some of the information you have provided to us any time via Account Management.
    ...
    Device identifiers such as your PlayStation console ID, mobile device IDs, cookie IDs, or se");
            WriteLiteral(@"rial numbers Network identifiers such as your IP address and MAC address Account authentication tokens that avoid you having to log in repeatedly Content and ads downloaded to your device for the online services that you access Your current and recent locations (e.g. on PS Vita) Trophies, scores and rankings achieved online and offline Information about the device you are using, any connected peripherals (such as controllers and VR headsets) and how you have configured them Information about how you use the software installed on your device (which may include information about the use of the software offline), such as date and time of use, what games or music you play, what content you browse, share or download, what services you access and for how long, including how often you use chat and other communication applications The actions you take within games or apps published by SIE (e.g. what obstacle you jump over and what levels you reach) Software errors and load times details, and if you have the ""Report S");
            WriteLiteral(@"ystem Software Errors Automatically"" setting turned on, detailed information about the crash, including screenshots and video captured before the crash
    ...
    Collect information about your use of PlayStation Network Services on your device. Log your activity on our PlayStation Network servers. For example, we may receive device and Account identifiers, such as your PlayStation Network Online ID and Account ID. We may also receive details of: the content, advertisements, and other information your devices request and receive from our servers (such as store content, trophies, and friends lists) and when you");
            WriteLiteral(@" receive and interact with them; what content and apps you add to your 'basket' in our Store; and what you purchase.
    Games
    ...
    Each time you visit our websites or receive and interact with our marketing communications and advertising on our and third-party websites and services, we may automatically log your activity on web, emails, or advertising and marketing servers we control through cookies (small information files placed on a hard drive),");
            WriteLiteral(@" web beacons, tracking pixels, browser configuration details (e.g. browser type, list of installed plugins and list of installed fonts), and embedded scripts (programming code that is temporarily downloaded onto a device).
    ...
    Game, social media, or other information, from those third parties or services you link your Account with, or who provide information to power PlayStation Network features. Information from other users, for example if those users have given us access to their profiles and if you are one of their connections, or information about you is otherwise made accessible to us by them. Information from third-parties as appropriate given our relationship, for example from anti-fraud service providers we might obtain fraud ri");
            WriteLiteral(@"sk scores; from law enforcement or partners, we might obtain IP addresses and details of suspected unlawful or malicious activity. Card account update information provided by your bank to help keep your payment cards up to date on your Account. Following any update, we will continue to charge the applicable payment methods to any purchases you make unless you notify us otherwise.
    Information Use
    ...
    We may use your information to operate our Services. We may also personalize the services we provide to you based on the information we have collected about you (for instance, we may");
            WriteLiteral(@" use your IP address to display content relevant for your area). And, to enable accessibility settings functions (for you, or other users), we may convert your voice data to text.
    ...
    We cannot monitor the whole of PlayStation Network and make no commitment to do so. However, we reserve the right in our sole discretion to monitor (including through the use of technology that automatically detects images, text, and URLs that breach our Terms of Service) and record your online activity and communication throughout PlayStation Network and to remove and/or delete any content. We may use the information we collect (as described above) to detect breaches and enforce our PlayStation Networ");
            WriteLiteral(@"k Terms of Service, Software Usage Terms, System Software License Agreements, any other terms of service you have agreed to and any rules or codes of conduct applicable to your use of PlayStation Network.
    ...
    We may use the information we collect for auditing, compliance a");
            WriteLiteral(@"nd legal purposes (for example, protecting the rights and property of Sony, its partners and customers).
    ...
    With parental consent, we will collect, use and share information collected from or about children in accordance with the ");
            WriteLiteral(@"practices described in this document, with the following exceptions.
    ...
    We advise you to make use of the enhanced account access controls that we make available such as 2-Step Verification. Please visit www.playstation.com and/or contact Play");
            WriteLiteral(@"Station Help and Support if you need any assistance in restricting access to your devices or accounts.
    ...
    We may retain information about you as long as it is necessary for us to fulfill the purposes outlined in this policy. In addition, we may retain your information for an additional period as is permitted or required to, among other things, comply with our legal obligations, resolve disputes, and enforce agreements. Where required by applicable law, we shall delete your information when the information is no longer necessary or req");
            WriteLiteral(@"uested to do so. Even if we delete your information from active databases, the information may remain on backup or archival media as well as other information systems.
